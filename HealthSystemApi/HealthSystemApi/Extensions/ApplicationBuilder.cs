...
namespace HealthSystemApi.Extensions
{
    public static class ApplicationBuilder
    {
        public static async void Initialize(this IApplicationBuilder app)
        {
            ...
            SeedSymptoms(services.GetRequiredService<ApplicationDbContext>());
        }

        private async static void SeedSymptoms(ApplicationDbContext context)
        {
            ...
            await context.SymptomCategories.AddRangeAsync(new List<SymptomCategory>()
            {
                ...
                new SymptomCategory() { Name = "Male Reproductice System" },
                new SymptomCategory() { Name = "Female Reproductice System" },
